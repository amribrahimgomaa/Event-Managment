        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Session["Id"] != null)
                {
                    ...
                    using (SqlConnection connection = new SqlConnection(@"Data Source=.;Initial Catalog=EventWeb;Integrated Security=True;"))
                    {
                        connection.Open();
                        string query = "SELECT TOP 1 * FROM AccountInfo WHERE ID = @UserID ORDER BY  AcoountID DESC;";
            ...
            try
            {
                ...
                // Check if a file is uploaded
                    ...
                    using (SqlConnection connection = new SqlConnection(@"Data Source=.;Initial Catalog=EventWeb;Integrated Security=True;"))
                    {
                        ...
                        string query = "INSERT INTO AccountInfo(ID,  Username, Name, Email, Country, PhoneNumber) " +
